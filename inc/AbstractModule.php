...
abstract class Wallee_AbstractModule extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->description = sprintf(
            $this->l('This PrestaShop module enables to process payments with %s.'), 'wallee');
        $this->confirmUninstall = sprintf(
            $this->l('Are you sure you want to uninstall the %s module?'), 'wallee');
    ...
    protected function displayForm()
    {
        ...
        $fieldsForm[]['form'] = array(
            'legend' => array(
                'title' => 'wallee ' . $this->l('General Settings')
            ),
            'input' => $generalInputs,
            'buttons' => $buttons
        );
